...
a.error);console.error("[LWF] loaded count: %d/%d",a.loadedCount,a.total)};h.prototype.onLoad=function(a){var l=this,f=l.privateData._loaderData,d=f.loader,c=f.stageEventReceiver;l.privateData=null;if(a){if(_.isFunction(f.callback.onLoad))f.callback.onLoad(a);var g,e,m,h,B,i=this.stage,t=0,x=0,w=1,r=0,s=0,E=b.performance.now(),F=0,z=E,G=0;a.rootMovie.moveTo(d.rootOffset.x,d.rootOffset.y);b.lwfs_loader_mode||(a.width=d.stageWidth?d.stageWidth:a.width,a.height=d.stageHeight?d.stageHeight:a.height);
b.lwfWidth=a.width;b.lwfHeight=a.height;var H=b.devicePixelRatio;"useWebkitCSSRenderer"===d.getRenderer()&&(H=1);g=function(){try{if(a){var e=d.stageWidth?d.stageWidth:a.width,p=d.stageHeight?d.stageHeight:a.height,n=d.screenWidth?d.screenWidth:b.innerWidth,q=d.screenHeight?d.screenHeight:b.innerHeight,h=n/q,m=e/p;v&&(b.innerWidth>b.screen.width&&(n=b.screen.width),b.innerHeight>b.screen.height&&(q=b.screen.height));e>n&&(p*=n/e,e=n);p>q&&(e*=q/p,p=q);if(t!==n||x!==q){r=e;s=p;l.fitForWidth?(r=Math.round(n),
s=Math.round(n*p/e)):l.fitForHeight?(r=Math.round(q*e/p),s=Math.round(q)):f.fitToScreen&&(h>m?(r=e*(q/p),s=q):(r=n,s=p*(n/e)));p=e=0;e=-1==d.stageHAlign?0:1==d.stageHAlign?Math.round(n-r):Math.round((n-r)/2);p=-1==d.stageVAlign?0:1==d.stageVAlign?Math.round(q-s):Math.round((q-s)/2);i.width=d.stageWidth?d.stageWidth:i.width;i.height=d.stageHeight?d.stageHeight:i.height;c.style.left=i.style.left=e+"px";c.style.top=i.style.top=p+"px";c.style.width=i.style.width=r+"px";c.style.height=i.style.height=s+
"px";c.width=i.width=Math.floor(r*H);c.height=i.height=Math.floor(s*H);f.fitToScreen?h<m?(w=r/i.width,a.property.clear(),a.fitForWidth(i.width,i.height)):(w=s/i.height,a.property.clear(),a.fitForHeight(i.width,i.height)):l.fitForWidth?(w=r/i.width,a.property.clear(),a.fitForWidth(i.width,i.height)):(w=s/i.height,a.property.clear(),a.fitForHeight(i.width,i.height));a.property.moveTo(0,0);if(d.displayDivId){var j=document.getElementById(d.displayDivId);f.fitToScreen?(j.style.width=n+"px",j.style.height=
q+"px"):(j.style.width=r+"px",j.style.height=s+"px")}t=n;x=q}var k=b.performance.now(),n=k-E;E=k;d.pausing||(a.exec(n/1E3),a.render());b.requestAnimationFrame(g);0===F%60&&(G=Math.round(6E4/(k-z)),z=k,F=0);if(d.debug||f.debug)document.getElementById("lwf_info"+f.debugInfoElementId).innerHTML=G+"fps";F++;d.setCurrentFPS(G)}}catch(B){d.handleException_(B,f)}};e=function(c){try{if(d.isPreventDefaultEnabled&&c.preventDefault(),a){var b,e,g=i.getBoundingClientRect();if(j){var h=c.touches[0];b=h.pageX;
e=h.pageY}else b=c.clientX,e=c.clientY;j?(b=b-g.left-window.scrollX,e=e-g.top-window.scrollY):(b-=g.left,e-=g.top);b/=w;e/=w;a.inputPoint(b,e)}}catch(l){d.handleException_(l,f)}};m=function(c){try{if(d.isPreventDefaultEnabled&&c.preventDefault(),a){var b,e,g=i.getBoundingClientRect();if(j){var h=c.touches[0];b=h.pageX;e=h.pageY}else b=c.clientX,e=c.clientY;j?(b=b-g.left-window.scrollX,e=e-g.top-window.scrollY):(b-=g.left,e-=g.top);b/=w;e/=w;a.inputPoint(b,e);a.inputPress()}}catch(l){d.handleException_(l,
f)}};h=function(c){try{d.isPreventDefaultEnabled&&c.preventDefault(),a&&a.inputRelease()}catch(b){d.handleException_(b,f)}};B=function(c){try{a&&b.location.reload(!0)}catch(e){d.handleException_(e,f)}};b.requestAnimationFrame(g);j?(v&&(A||/ SC-0/.test(u))&&document.body.addEventListener("touchstart",function(){}),y&&(d.debug||f.debug)&&c.addEventListener("gestureend",B,!1),c.addEventListener("touchmove",e,!1),c.addEventListener("touchstart",m,!1),c.addEventListener("touchend",h,!1)):(c.addEventListener("mousemove",
e,!1),c.addEventListener("mousedown",m,!1),c.addEventListener("mouseup",h,!1));_.each(f.buttonEventMap,function(c,b){_.isFunction(c)?c={release:c}:_.each(c,function(a,c){if(!_.isFunction(a))throw Error("button event ["+c+"@"+b+"] is not a function!");});a.setButtonEventHandler(b,c)});var C={},D=function(a,c){C.hasOwnProperty(a)||(C[a]=[]);C[a].push(c)};_.isObject(f.fsCommandMap)&&_.each(f.fsCommandMap,function(a,c){_.isFunction(a)&&D(c,a)});_.isObject(f.pageTransitionMap)&&_.each(f.pageTransitionMap,
function(a,c){_.isString(a)?D(c,function(){document.location.href=a}):_.isFunction(a)&&D(c,function(){a(c)})});D=null;_.each(C,function(c,b){a.setEventHandler(b,function(a,b){for(var d=c.length,e=0;e<d;++e)c[e](a,b)})});C=null}else d.handleLoadError_(this,f)};h.prototype.playLWF=function(a,h){var f=a.getAttribute("data-lwf-display_setting");f&&(f=JSON.parse(f),this.setDisplaySetting(f));f=b.LWF;this.getRenderer()||this.setRenderer(b.Utility.autoSelectRenderer());var d=this.getRenderer();if(d)f[d]();
else throw Error("Renderer parameters are not properly set");f=f.ResourceCache.get();this.debug&&(b.LWFLOADER_ENABLE_DEBUG=!0);var c={};c.onload=this.onLoad;this.backgroundColor?c.setBackgroundColor=this.backgroundColor:c.useBackgroundColor=!0;c.fitForHeight=!1;c.fitForWidth=!1;"fitForWidth"===this.resizeMode?c.fitForWidth=!0:"fitForHeight"===this.resizeMode?c.fitForHeight=!0:"fitToScreen"===this.resizeMode&&(this.fitToScreen=!0);c.fitToScreen=this.fitToScreen;c.worker=t;v&&(/ (SC-0|Galaxy Nexus)/.test(u)&&
"useWebkitCSSRenderer"===d)&&(c.quirkyClearRect=!0);v&&(c.use3D=!1);c.privateData={};c.pos=null;c.imageMap={};c.soundMap={};c.pageTransitionMap={};c.buttonEventMap={};c.fsCommandMap={};c.handler={};c.callback={};c.lwfMap=null;for(var g=function(a){return a.charAt(1).toUpperCase()},e=0;e<a.attributes.length;e++){var m=a.attributes[e];if(m.name&&0===m.name.indexOf("data-lwf-")){var k=m.name.slice(9),k=k.replace(/_./g,g);if("displaySetting"!==k){m=m.value;try{"{"===m.charAt(0)&&(m=JSON.parse(m))}catch(B){}c[k]=
m}}}2===b.devicePixelRatio&&this.useLargeImage&&(c.imageSuffix="_@2x");c.hasOwnProperty("lwf")||(g=a.getAttribute("data-lwf"),_.isString(g)&&(c.lwf=g));c.hasOwnProperty("name")&&(c.lwf=c.name);_.isObject(h)&&_.extend(c,h);0<this.initializeHooks.length&&_.each(this.initializeHooks,_.bind(function(b){if(_.isFunction(b)){b=b.call(this,a);for(var d in b)b.hasOwnProperty(d)&&_.extend(c[d],b[d])}},this));this.initializeHooks=[];if(!c.hasOwnProperty("lwf"))throw Error("[LWF] no LWF input");g={};g.debugInfoElementId=
++z;g.setting=c;g.loader=this;g.debug=!1;g.soundMap=null;g.pageTransitionMap=null;g.buttonEventMap=null;g.fsCommandMap=null;g.handler=null;g.callback=null;g.stageEventReceiver=null;g.lwfMap=null;g.debug=this.debug;c.privateData.hasOwnProperty("lwfLoader")||(c.privateData.lwfLoader=this);c.imageMap=this.getImageMapper_(c.imageMap);_.isEmpty(c.soundMap)||(g.soundMap=c.soundMap);delete c.soundMap;_.isObject(c.pageTransitionMap)&&(g.pageTransitionMap=c.pageTransitionMap);delete c.pageTransitionMap;g.buttonEventMap=
c.buttonEventMap;delete c.buttonEventMap;_.isEmpty(c.fsCommandMap)||(g.fsCommandMap=c.fsCommandMap);delete c.fsCommandMap;_.isEmpty(c.handler)||(g.handler=c.handler);delete c.handler;g.callback=c.callback;delete c.callback;g.lwfMap=c.lwfMap;delete c.lwfMap;g.fitToScreen=c.fitToScreen;delete c.fitToScreen;this.isLwfsEnvironment_()&&(e=c.prefix?c.prefix+c.lwf:c.lwf,c.prefix=e.slice(0,e.lastIndexOf("/")+1),delete c.imagePrefix,c.lwf=e.slice(e.lastIndexOf("/")+1));e={position:"absolute",top:0,left:0};
_.extend(e,c.pos);delete c.pos;if("static"===a.style.position||""===a.style.position)a.style.position="relative";d=x(d);d.style.position=e.position;d.style.top=e.top+"px";d.style.left=e.left+"px";d.style.zIndex=a.style.zIndex+1;a.appendChild(d);k=null;j?(k=document.createElement("div"),k.style.position="absolute",k.style.top=e.top+"px",k.style.left=e.left+"px",k.style.zIndex=d.style.zIndex+1,a.appendChild(k)):k=d;c.stage=d;g.stageEventReceiver=k;if(this.debug||g.debug)d=document.createElement("div"),
