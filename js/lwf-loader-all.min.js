...
/\.lwf.js(\?.*)?$/.test(b.lwf);if(b.hasOwnProperty("_loaderData"))throw Error("cannot use '_loaderData' property that used by lwf-loader!");b.privateData._loaderData=g;e.loadLWF(b)}else console.error("[LWF] no LWF input")};h.prototype.requestLWF_=function(c,a,e,f,b){var g={};if(this.isLwfsEnvironment_()){var d=_.clone(window.testlwf_settings);d.prefix?g=d.prefix+a+"/_/":(g=document.location.pathname,g=g.replace(c.name,a),g=g.slice(0,g.lastIndexOf("/")+1)+"_/");d.prefix=g;delete d.imagePrefix;g=this.getLwfPath_(a);
if(!g)return console.error("[LWF] no LWF input"),b("no LWF input",null),null;d.lwf=g;m&&(d.lwf+=".js");d.parentLWF=c;d.stage=c.stage;d.worker=p;d.active=!1;e&&(d.imageMap=this.getImageMapper_(e));f&&(d.privateData=f);d.onload=function(a){var c=this.privateData.lwfLoader;return!a?(c.handleLoadError_(this),b(this.error,a)):b(null,a)}}else{d=c.privateData;if("undefined"===typeof d)return console.error("[LWF] Parent private data is not found"),b("no parents data found",null),null;var h=_.clone(d._loaderData);
if("undefined"===typeof h)return console.error("[LWF] Parent Loader data is not found"),b("no loader parameters to inherit"),null;d=_.clone(h.setting);d.fitForHeight=d.fitForWidth=!1;h.setting=d;g=null;try{g=this.getLwfMapper_(h)(a)}catch(i){this.handleException_(i,h)}if(!g)return console.error("[LWF] no LWF input"),b("no LWF input",null),null;d.lwf=g;h.useLwfJs&&(d.lwf+=".js");d.parentLWF=c;d.stage=c.stage;d.worker=p;d.active=!1;e&&(d.imageMap=this.getImageMapper_(e));f&&(f._loaderData=h,d.privateData=
f,f.prefix&&(d.prefix=f.prefix),f.imagePrefix&&(d.imagePrefix=f.imagePrefix));d.onload=function(a){var c=h.loader;return!a?(c.handleLoadError_(this,h),b(this.error,a)):b(null,a)}}return d};h.prototype.requestLWF=function(a,h,e,f,b){a=this.requestLWF_(a,h,e,f,b);_.isNull(a)||this.requests.push(a)};h.prototype.loadLWF=function(c,h,e,f,b){c=this.requestLWF_(c,h,e,f,b);_.isNull(c)||a.LWF.ResourceCache.get().loadLWF(c)};h.prototype.loadLWFs=function(c){a.LWF.ResourceCache.get().loadLWFs(this.requests,
c);this.requests=[]};a.LwfLoader=h})(window);
