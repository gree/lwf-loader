...
c.useBackgroundColor=!0;c.fitForHeight=!1;c.fitForWidth=!1;"fitForWidth"===this.resizeMode?c.fitForWidth=!0:"fitForHeight"===this.resizeMode&&(c.fitForHeight=!0);c.resizeStretch=this.resizeStretch;c.widthLimit=this.widthLimit;c.heightLimit=this.heightLimit;c.worker=n;p&&(/ SC-0/.test(k)&&"useWebkitCSSRenderer"===f)&&(c.quirkyClearRect=!0);p&&(c.use3D=!1);c.privateData={};c.pos=null;c.imageMap={};c.soundMap={};c.pageTransitionMap={};c.buttonEventMap={};c.fsCommandMap={};c.handler={};c.callback={};
c.lwfMap=null;for(var g=function(a){return a.charAt(1).toUpperCase()},d=0;d<a.attributes.length;d++){var h=a.attributes[d];if(h.name&&0===h.name.indexOf("data-lwf-")){var j=h.name.slice(9),j=j.replace(/_./g,g);if("displaySetting"!==j){h=h.value;try{"{"===h.charAt(0)&&(h=JSON.parse(h))}catch(D){}c[j]=h}}}2===b.devicePixelRatio&&this.useLargeImage&&(c.imageSuffix="_@2x");c.hasOwnProperty("lwf")||(g=a.getAttribute("data-lwf"),_.isString(g)&&(c.lwf=g));c.hasOwnProperty("name")&&(c.lwf=c.name);_.isObject(i)&&
_.extend(c,i);0<this.initializeHooks.length&&_.each(this.initializeHooks,_.bind(function(b){if(_.isFunction(b)){b=b.call(this,a);for(var d in b)b.hasOwnProperty(d)&&_.extend(c[d],b[d])}},this));this.initializeHooks=[];if(!c.hasOwnProperty("lwf"))throw Error("[LWF] no LWF input");g={};g.debugInfoElementId=++x;g.setting=c;g.loader=this;g.debug=!1;g.soundMap=null;g.pageTransitionMap=null;g.buttonEventMap=null;g.fsCommandMap=null;g.handler=null;g.callback=null;g.stageEventReceiver=null;g.lwfMap=null;
g.debug=this.debug;c.privateData.hasOwnProperty("lwfLoader")||(c.privateData.lwfLoader=this);c.imageMap=this.getImageMapper_(c.imageMap);_.isEmpty(c.soundMap)||(g.soundMap=c.soundMap);delete c.soundMap;_.isObject(c.pageTransitionMap)&&(g.pageTransitionMap=c.pageTransitionMap);delete c.pageTransitionMap;g.buttonEventMap=c.buttonEventMap;delete c.buttonEventMap;_.isEmpty(c.fsCommandMap)||(g.fsCommandMap=c.fsCommandMap);delete c.fsCommandMap;_.isEmpty(c.handler)||(g.handler=c.handler);delete c.handler;
g.callback=c.callback;delete c.callback;g.lwfMap=c.lwfMap;delete c.lwfMap;g.resizeStretch=c.resizeStretch;delete c.resizeStretch;this.isLwfsEnvironment_()&&(d=c.prefix?c.prefix+c.lwf:c.lwf,c.prefix=d.slice(0,d.lastIndexOf("/")+1),delete c.imagePrefix,c.lwf=d.slice(d.lastIndexOf("/")+1));d={position:"absolute",top:0,left:0};_.extend(d,c.pos);delete c.pos;if("static"===a.style.position||""===a.style.position)a.style.position="relative";f=s(f);f.style.position=d.position;f.style.top=d.top+"px";f.style.left=
d.left+"px";f.style.zIndex=a.style.zIndex+1;a.appendChild(f);j=null;m?(j=document.createElement("div"),j.style.position="absolute",j.style.top=d.top+"px",j.style.left=d.left+"px",j.style.zIndex=f.style.zIndex+1,a.appendChild(j)):j=f;c.stage=f;g.stageEventReceiver=j;if(this.debug||g.debug)f=document.createElement("div"),f.id="lwf_info"+x,f.style.position=d.position,f.style.top=d.top+"px",f.style.left=d.left+"px",f.style.color="white",f.style.zIndex=1E4,a.appendChild(f);if(c.lwf){g.useLwfJs=/\.lwf.js(\?.*)?$/.test(c.lwf);
if(c.hasOwnProperty("_loaderData"))throw Error("cannot use '_loaderData' property that used by lwf-loader!");c.privateData._loaderData=g;e.loadLWF(c)}else console.error("[LWF] no LWF input")};h.prototype.requestLWF_=function(a,b,e,f,c){var g={};if(this.isLwfsEnvironment_()){var d=_.clone(window.testlwf_settings);d.prefix?g=d.prefix+b+"/_/":(g=document.location.pathname,g=g.replace(a.name,b),g=g.slice(0,g.lastIndexOf("/")+1)+"_/");d.prefix=g;delete d.imagePrefix;g=this.getLwfPath_(b);if(!g)return console.error("[LWF] no LWF input"),
c("no LWF input",null),null;d.lwf=g;p&&(d.lwf+=".js");d.parentLWF=a;d.stage=a.stage;d.worker=n;d.active=!1;e&&(d.imageMap=this.getImageMapper_(e));f&&(d.privateData=f);d.onload=function(a){var b=this.privateData.lwfLoader;return!a?(b.handleLoadError_(this),c(this.error,a)):c(null,a)}}else{d=a.privateData;if("undefined"===typeof d)return console.error("[LWF] Parent private data is not found"),c("no parents data found",null),null;var h=_.clone(d._loaderData);if("undefined"===typeof h)return console.error("[LWF] Parent Loader data is not found"),
c("no loader parameters to inherit"),null;d=_.clone(h.setting);d.fitForHeight=d.fitForWidth=!1;h.setting=d;g=null;try{g=this.getLwfMapper_(h)(b)}catch(j){this.handleException_(j,h)}if(!g)return console.error("[LWF] no LWF input"),c("no LWF input",null),null;d.lwf=g;h.useLwfJs&&(d.lwf+=".js");d.parentLWF=a;d.stage=a.stage;d.worker=n;d.active=!1;e&&(d.imageMap=this.getImageMapper_(e));f&&(f._loaderData=h,d.privateData=f,f.prefix&&(d.prefix=f.prefix),f.imagePrefix&&(d.imagePrefix=f.imagePrefix));d.onload=
function(a){var b=h.loader;return!a?(b.handleLoadError_(this,h),c(this.error,a)):c(null,a)}}return d};h.prototype.requestLWF=function(a,b,e,f,c){a=this.requestLWF_(a,b,e,f,c);_.isNull(a)||this.requests.push(a)};h.prototype.loadLWF=function(a,h,e,f,c){a=this.requestLWF_(a,h,e,f,c);_.isNull(a)||b.LWF.ResourceCache.get().loadLWF(a)};h.prototype.loadLWFs=function(a){b.LWF.ResourceCache.get().loadLWFs(this.requests,a);this.requests=[]};b.LwfLoader=h})(window);
