...
0===w%60&&(H=Math.round(6E4/(q-D)),D=q,w=0);if(h.debug||c.debug)document.getElementById("lwf_info"+c.debugInfoElementId).innerHTML=H+"fps";w++;h.currentFPS=H}}catch(n){h.handleException_(n,c)}};e=function(b){try{if(t&&b.preventDefault(),d){var a,e,g=m.getBoundingClientRect();if(k){var f=b.touches[0];a=f.pageX;e=f.pageY}else a=b.offsetX,e=b.offsetY;k&&(a-=m.offsetLeft,e-=m.offsetTop,a=a-g.left-window.scrollX,e=e-g.top-window.scrollY);a/=z;e/=z;d.inputPoint(a,e)}}catch(i){h.handleException_(i,c)}};
q=function(a){try{if(t&&a.preventDefault(),d){var b,e,g=m.getBoundingClientRect();if(k){var f=a.touches[0];b=f.pageX;e=f.pageY}else b=a.offsetX,e=a.offsetY;k&&(b-=m.offsetLeft,e-=m.offsetTop,b=b-g.left-window.scrollX,e=e-g.top-window.scrollY);b/=z;e/=z;d.inputPoint(b,e);d.inputPress()}}catch(i){h.handleException_(i,c)}};n=function(b){try{t&&b.preventDefault(),d&&d.inputRelease()}catch(a){h.handleException_(a,c)}};y=function(b){try{d&&a.location.reload(!0)}catch(e){h.handleException_(e,c)}};a.requestAnimationFrame(g);
k?(l&&(C||/ SC-0/.test(j))&&document.body.addEventListener("touchstart",function(){}),u&&(h.debug||c.debug)&&b.addEventListener("gestureend",y,!1),b.addEventListener("touchmove",e,!1),b.addEventListener("touchstart",q,!1),b.addEventListener("touchend",n,!1)):(b.addEventListener("mousemove",e,!1),b.addEventListener("mousedown",q,!1),b.addEventListener("mouseup",n,!1));_.each(c.buttonEventMap,function(b,a){_.isFunction(b)?b={release:b}:_.each(b,function(b,d){if(!_.isFunction(b))throw Error("button event ["+
d+"@"+a+"] is not a function!");});d.setButtonEventHandler(a,b)});var E={},G=function(b,a){E.hasOwnProperty(b)||(E[b]=[]);E[b].push(a)};_.isObject(c.fsCommandMap)&&_.each(c.fsCommandMap,function(b,a){_.isFunction(b)&&G(a,b)});_.isObject(c.pageTransitionMap)&&_.each(c.pageTransitionMap,function(b,a){_.isString(b)?G(a,function(){document.location.href=b}):_.isFunction(b)&&G(a,function(){b(a)})});G=null;_.each(E,function(b,a){d.setEventHandler(a,function(a,d){for(var c=b.length,e=0;e<c;++e)b[e](a,d)})});
E=null}else h.handleLoadError_(this,c)};f.prototype.playLWF=function(d,f){var c=d.getAttribute("data-lwf-display_setting"),c=c?JSON.parse(c):{};v=c.resizeMode||v;w=c.resizeStretch||w;F=c.displayDivId||F;var h;h=a.LWF;if(i){if(c.renderer&&i!==c.renderer)throw Error("cannot use multiple renderer! LWF has been initialized for "+i+" renderer.");}else if(i=c.renderer||a.Utility.getRenderer(),"canvas"===i?i="useCanvasRenderer":"webkitcss"===i?i="useWebkitCSSRenderer":"webgl"===i&&(i="useWebGLRenderer"),
i.match(/use.+Renderer/i))h[i]();else throw Error("Renderer parameters are not properly set");h=h.ResourceCache.get();var b=_.isObject(a.lwfDefaultParam)?_.clone(a.lwfDefaultParam):{};b.onload=this.onLoad;_.isUndefined(c.backgroundColor)?b.useBackgroundColor=!0:b.setBackgroundColor=c.backgroundColor;b.fitForHeight=!1;b.fitForWidth=!1;b[v]=!0;b.resizeStretch=w;b.widthLimit=c.widthLimit;b.heightLimit=c.heightLimit;b.worker=x;l&&(/ SC-0/.test(j)&&"useWebkitCSSRenderer"===i)&&(b.quirkyClearRect=!0);l&&
(b.use3D=!1);b.privateData={};b.pos=null;b.imageMap={};b.soundMap={};b.pageTransitionMap={};b.buttonEventMap={};b.fsCommandMap={};b.handler={};b.callback={};b.lwfMap=null;for(c=0;c<d.attributes.length;c++){var g=d.attributes[c];if(g.name&&0===g.name.indexOf("data-lwf-")){var e=g.name.slice(9),e=e.replace(/_./g,function(b){return b.charAt(1).toUpperCase()});if("displaySetting"!==e){g=g.value;try{"{"===g.charAt(0)&&(g=JSON.parse(g))}catch(q){}b[e]=g}}}2==a.devicePixelRatio&&b.useHighResImage&&(b.imageSuffix=
"_@2x");b.hasOwnProperty("lwf")||(c=d.getAttribute("data-lwf"),_.isString(c)&&(b.lwf=c));b.hasOwnProperty("name")&&(b.lwf=b.name);_.isObject(f)&&_.extend(b,f);0<this.initializeHooks.length&&_.each(this.initializeHooks,_.bind(function(a){if(_.isFunction(a)){a=a.call(this,d);for(var c in a)a.hasOwnProperty(c)&&_.extend(b[c],a[c])}},this));this.initializeHooks=[];if(!b.hasOwnProperty("lwf"))throw Error("[LWF] no LWF input");c={};c.debugInfoElementId=++D;c.setting=b;c.loader=this;c.debug=!1;c.soundMap=
null;c.pageTransitionMap=null;c.buttonEventMap=null;c.fsCommandMap=null;c.handler=null;c.callback=null;c.stageEventReceiver=null;c.lwfMap=null;c.debug=this.debug;b.privateData.hasOwnProperty("lwfLoader")||(b.privateData.lwfLoader=this);b.imageMap=this.getImageMapper_(b.imageMap);_.isEmpty(b.soundMap)||(c.soundMap=b.soundMap);delete b.soundMap;_.isObject(b.pageTransitionMap)&&(c.pageTransitionMap=b.pageTransitionMap);delete b.pageTransitionMap;c.buttonEventMap=b.buttonEventMap;delete b.buttonEventMap;
_.isEmpty(b.fsCommandMap)||(c.fsCommandMap=b.fsCommandMap);delete b.fsCommandMap;_.isEmpty(b.handler)||(c.handler=b.handler);delete b.handler;c.callback=b.callback;delete b.callback;c.lwfMap=b.lwfMap;delete b.lwfMap;c.resizeStretch=b.resizeStretch;delete b.resizeStretch;this.isLwfsEnvironment_()&&(e=b.prefix?b.prefix+b.lwf:b.lwf,b.prefix=e.slice(0,e.lastIndexOf("/")+1),delete b.imagePrefix,b.lwf=e.slice(e.lastIndexOf("/")+1));e={position:"absolute",top:0,left:0};_.extend(e,b.pos);delete b.pos;if("static"===
d.style.position||""===d.style.position)d.style.position="relative";g=p(i);g.style.position=e.position;g.style.top=e.top+"px";g.style.left=e.left+"px";g.style.zIndex=d.style.zIndex+1;d.appendChild(g);var n=null;k?(n=document.createElement("div"),n.style.position="absolute",n.style.top=e.top+"px",n.style.left=e.left+"px",n.style.zIndex=g.style.zIndex+1,d.appendChild(n)):n=g;b.stage=g;c.stageEventReceiver=n;if(this.debug||c.debug)g=document.createElement("div"),g.id="lwf_info"+D,g.style.position=e.position,
g.style.top=e.top+"px",g.style.left=e.left+"px",g.style.color="white",g.style.zIndex=1E4,d.appendChild(g);if(b.lwf){c.useLwfJs=/\.lwf.js(\?.*)?$/.test(b.lwf);if(b.hasOwnProperty("_loaderData"))throw Error("cannot use '_loaderData' property that used by lwf-loader!");b.privateData._loaderData=c;h.loadLWF(b)}else console.error("[LWF] no LWF input")};f.prototype.requestLWF_=function(a,f,c,h,b){var g={};if(this.isLwfsEnvironment_()){var e=_.clone(window.testlwf_settings);e.prefix?g=e.prefix+f+"/_/":(g=
document.location.pathname,g=g.replace(a.name,f),g=g.slice(0,g.lastIndexOf("/")+1)+"_/");e.prefix=g;delete e.imagePrefix;g=this.getLwfPath_(f);if(!g)return console.error("[LWF] no LWF input"),b("no LWF input",null),null;e.lwf=g;l&&(e.lwf+=".js");e.parentLWF=a;e.stage=a.stage;e.worker=x;e.active=!1;c&&(e.imageMap=this.getImageMapper_(c));h&&(e.privateData=h);e.onload=function(a){var c=this.privateData.lwfLoader;return!a?(c.handleLoadError_(this),b(this.error,a)):b(null,a)}}else{e=a.privateData;if("undefined"===
typeof e)return console.error("[LWF] Parent private data is not found"),b("no parents data found",null),null;var i=_.clone(e._loaderData);if("undefined"===typeof i)return console.error("[LWF] Parent Loader data is not found"),b("no loader parameters to inherit"),null;e=_.clone(i.setting);e.fitForHeight=e.fitForWidth=!1;i.setting=e;g=null;try{g=this.getLwfMapper_(i)(f)}catch(j){this.handleException_(j,i)}if(!g)return console.error("[LWF] no LWF input"),b("no LWF input",null),null;e.lwf=g;i.useLwfJs&&
(e.lwf+=".js");e.parentLWF=a;e.stage=a.stage;e.worker=x;e.active=!1;c&&(e.imageMap=this.getImageMapper_(c));h&&(h._loaderData=i,e.privateData=h,h.prefix&&(e.prefix=h.prefix),h.imagePrefix&&(e.imagePrefix=h.imagePrefix));e.onload=function(a){var c=i.loader;return!a?(c.handleLoadError_(this,i),b(this.error,a)):b(null,a)}}return e};f.prototype.requestLWF=function(a,f,c,h,b){a=this.requestLWF_(a,f,c,h,b);_.isNull(a)||this.requests.push(a)};f.prototype.loadLWFs=function(d){a.LWF.ResourceCache.get().loadLWFs(this.requests,
d);this.requests=[]};f.prototype.loadLWF=function(d,f,c,h,b){d=this.requestLWF_(d,f,c,h,b);_.isNull(d)||a.LWF.ResourceCache.get().loadLWF(d)};a.LwfLoader=f;f.prototype.playLWF=f.prototype.playLWF;f.prototype.loadLWF=f.prototype.loadLWF;f.prototype.addInitializeHook=f.prototype.addInitializeHook})(window);
