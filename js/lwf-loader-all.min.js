...
a.error);console.error("[LWF] loaded count: %d/%d",a.loadedCount,a.total)};h.prototype.onLoad=function(a){var l=this,f=l.privateData._loaderData,d=f.loader,c=f.stageEventReceiver;l.privateData=null;if(a){if(_.isFunction(f.callback.onLoad))f.callback.onLoad(a);var g,e,m,h,B,i=this.stage,t=0,x=0,w=1,r=0,s=0,E=b.performance.now(),F=0,z=E,G=0;a.rootMovie.moveTo(d.rootOffset.x,d.rootOffset.y);a.width=d.stageWidth?d.stageWidth:a.width;a.height=d.stageHeight?d.stageHeight:a.height;var H=b.devicePixelRatio;
"useWebkitCSSRenderer"===d.getRenderer()&&(H=1);g=function(){try{if(a){var e=a.width,p=a.height,n=d.screenWidth?d.screenWidth:b.innerWidth,q=d.screenHeight?d.screenHeight:b.innerHeight,h=n/q,m=e/p;v&&(b.innerWidth>b.screen.width&&(n=b.screen.width),b.innerHeight>b.screen.height&&(q=b.screen.height));e>n&&(p*=n/e,e=n);p>q&&(e*=q/p,p=q);if(t!==n||x!==q){r=e;s=p;l.fitForWidth?(r=Math.round(n),s=Math.round(n*p/e)):l.fitForHeight?(r=Math.round(q*e/p),s=Math.round(q)):f.fitToScreen&&(h>m?(r=e*(q/p),s=q):
(r=n,s=p*(n/e)));p=e=0;e=-1==d.stageHAlign?0:1==d.stageHAlign?Math.round(n-r):Math.round((n-r)/2);p=-1==d.stageVAlign?0:1==d.stageVAlign?Math.round(q-s):Math.round((q-s)/2);i.width=d.stageWidth?d.stageWidth:i.width;i.height=d.stageHeight?d.stageHeight:i.height;c.style.left=i.style.left=e+"px";c.style.top=i.style.top=p+"px";c.style.width=i.style.width=r+"px";c.style.height=i.style.height=s+"px";c.width=i.width=Math.floor(r*H);c.height=i.height=Math.floor(s*H);f.fitToScreen?h<m?(w=r/i.width,a.property.clear(),
a.fitForWidth(i.width,i.height)):(w=s/i.height,a.property.clear(),a.fitForHeight(i.width,i.height)):l.fitForWidth?(w=r/i.width,a.property.clear(),a.fitForWidth(i.width,i.height)):(w=s/i.height,a.property.clear(),a.fitForHeight(i.width,i.height));a.property.moveTo(0,0);if(d.displayDivId){var j=document.getElementById(d.displayDivId);f.fitToScreen?(j.style.width=n+"px",j.style.height=q+"px"):(j.style.width=r+"px",j.style.height=s+"px")}t=n;x=q}var k=b.performance.now(),n=k-E;E=k;d.pausing||(a.exec(n/
1E3),a.render());b.requestAnimationFrame(g);0===F%60&&(G=Math.round(6E4/(k-z)),z=k,F=0);if(d.debug||f.debug)document.getElementById("lwf_info"+f.debugInfoElementId).innerHTML=G+"fps";F++;d.setCurrentFPS(G)}}catch(B){d.handleException_(B,f)}};e=function(c){try{if(d.isPreventDefaultEnabled&&c.preventDefault(),a){var b,e,g=i.getBoundingClientRect();if(j){var h=c.touches[0];b=h.pageX;e=h.pageY}else b=c.clientX,e=c.clientY;j?(b=b-g.left-window.scrollX,e=e-g.top-window.scrollY):(b-=g.left,e-=g.top);b/=
w;e/=w;a.inputPoint(b,e)}}catch(l){d.handleException_(l,f)}};m=function(c){try{if(d.isPreventDefaultEnabled&&c.preventDefault(),a){var b,e,g=i.getBoundingClientRect();if(j){var h=c.touches[0];b=h.pageX;e=h.pageY}else b=c.clientX,e=c.clientY;j?(b=b-g.left-window.scrollX,e=e-g.top-window.scrollY):(b-=g.left,e-=g.top);b/=w;e/=w;a.inputPoint(b,e);a.inputPress()}}catch(l){d.handleException_(l,f)}};h=function(c){try{d.isPreventDefaultEnabled&&c.preventDefault(),a&&a.inputRelease()}catch(b){d.handleException_(b,
f)}};B=function(c){try{a&&b.location.reload(!0)}catch(e){d.handleException_(e,f)}};b.requestAnimationFrame(g);j?(v&&(A||/ SC-0/.test(u))&&document.body.addEventListener("touchstart",function(){}),y&&(d.debug||f.debug)&&c.addEventListener("gestureend",B,!1),c.addEventListener("touchmove",e,!1),c.addEventListener("touchstart",m,!1),c.addEventListener("touchend",h,!1)):(c.addEventListener("mousemove",e,!1),c.addEventListener("mousedown",m,!1),c.addEventListener("mouseup",h,!1));_.each(f.buttonEventMap,
function(c,b){_.isFunction(c)?c={release:c}:_.each(c,function(a,c){if(!_.isFunction(a))throw Error("button event ["+c+"@"+b+"] is not a function!");});a.setButtonEventHandler(b,c)});var C={},D=function(a,c){C.hasOwnProperty(a)||(C[a]=[]);C[a].push(c)};_.isObject(f.fsCommandMap)&&_.each(f.fsCommandMap,function(a,c){_.isFunction(a)&&D(c,a)});_.isObject(f.pageTransitionMap)&&_.each(f.pageTransitionMap,function(a,c){_.isString(a)?D(c,function(){document.location.href=a}):_.isFunction(a)&&D(c,function(){a(c)})});
D=null;_.each(C,function(c,b){a.setEventHandler(b,function(a,b){for(var e=c.length,d=0;d<e;++d)c[d](a,b)})});C=null}else d.handleLoadError_(this,f)};h.prototype.playLWF=function(a,h){var f=a.getAttribute("data-lwf-display_setting");f&&(f=JSON.parse(f),this.setDisplaySetting(f));f=b.LWF;this.getRenderer()||this.setRenderer(b.Utility.autoSelectRenderer());var d=this.getRenderer();if(d)f[d]();else throw Error("Renderer parameters are not properly set");f=f.ResourceCache.get();this.debug&&(b.LWFLOADER_ENABLE_DEBUG=
!0);var c={};c.onload=this.onLoad;this.backgroundColor?c.setBackgroundColor=this.backgroundColor:c.useBackgroundColor=!0;c.fitForHeight=!1;c.fitForWidth=!1;"fitForWidth"===this.resizeMode?c.fitForWidth=!0:"fitForHeight"===this.resizeMode?c.fitForHeight=!0:"fitToScreen"===this.resizeMode&&(this.fitToScreen=!0);c.fitToScreen=this.fitToScreen;c.widthLimit=this.widthLimit;c.heightLimit=this.heightLimit;c.worker=t;v&&(/ (SC-0|Galaxy Nexus)/.test(u)&&"useWebkitCSSRenderer"===d)&&(c.quirkyClearRect=!0);
