...
b.devicePixelRatio;"useWebkitCSSRenderer"===f.getRenderer()&&(d=1);var q=a.width,r=a.height,h=b.innerWidth,t=b.innerHeight;p&&(b.innerWidth>b.screen.width&&(h=b.screen.width),b.innerHeight>b.screen.height&&(t=b.screen.height));if(q>h||e.resizeStretch)q=h;if(r>t||e.resizeStretch)r=t;if(n!==q||s!==r)if(n=q,s=r,i.fitForWidth?(i.widthLimit&&(q=q>i.widthLimit?i.widthLimit:q),v=Math.round(q),w=Math.round(q*a.height/a.width)):(i.heightLimit&&(r=r>i.heightLimit?i.heightLimit:r),v=Math.round(r*a.width/a.height),
w=Math.round(r)),c.style.width=l.style.width=v+"px",c.style.height=l.style.height=w+"px",c.width=l.width=Math.floor(v*d),c.height=l.height=Math.floor(w*d),i.fitForWidth?(u=v/l.width,a.property.clear(),a.fitForWidth(l.width,l.height)):(u=w/l.height,a.property.clear(),a.fitForHeight(l.width,l.height)),f.displayDivId){var k=document.getElementById(f.displayDivId);k.style.width=v+"px";k.style.height=w+"px"}var j=b.performance.now(),d=j-E;E=j;f.pausing||(a.exec(d/1E3),a.render());b.requestAnimationFrame(g);
