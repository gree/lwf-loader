...
return d.setTimeout(function(){l=d.performance.now();f()},a-(g>a?g%a:g))};d.cancelAnimationFrame=function(a){return d.clearTimeout(a)}}();h.prototype.isLwfsEnvironment_=function(){return d.testlwf_settings&&!this.isLwfsLoaderEnvironment_()};h.prototype.isLwfsLoaderEnvironment_=function(){return d.lwfs_loader_mode};h.prototype.setPreventDefaultBehaviour=function(a){this.isPreventDefaultEnabled=a};h.prototype.addInitializeHook=function(a){_.isFunction(a)&&this.initializeHooks.push(a)};h.prototype.pause=
function(){this.pausing=!0};h.prototype.resume=function(){this.pausing=!1};h.prototype.rewind=function(){this.gotoRewind=!0};h.prototype.getLwfMapper_=function(a){if(null===a.lwfMap)return _.bind(this.getLwfPath_,this);var d=a.lwfMap;if(_.isObject(d))return _.isFunction(d)?d:function(a){var g=a;d.hasOwnProperty(a)&&(g=d[a]);/\.lwf$/.test(g)||(g+=".lwf");return g};throw Error("unsupported lwfMap");};h.prototype.getLwfPath_=function(a){var d=a.replace(/\.lwf$/i,"");0<=a.indexOf("/")&&(d=a.substring(a.lastIndexOf("/")+
1));return this.isLwfsEnvironment_()||this.isLwfsLoaderEnvironment_()?d+".lwf":a+"/_/"+d+".lwf"};h.prototype.getImageMapper_=function(a){return _.isFunction(a)?a:function(d){return a[d]?a[d]:d}};h.prototype.autoSelectRenderer_=function(){if(this.useWebGL)for(var a=document.createElement("canvas"),d=["webgl","experimental-webgl","moz-webgl","webkit-3d"],f,g=0;g<d.length;g++)if(f=a.getContext(d[g]))return"useWebGLRenderer";return/iP(ad|hone|od).*OS 4/.test(k)||/Android 2\.1/.test(k)||/Android 2\.3\.[5-7]/.test(k)||
/Android 4/.test(k)&&!/Chrome/.test(k)?"useWebkitCSSRenderer":"useCanvasRenderer"};h.prototype.setDisplaySetting=function(a){a.renderer&&this.setRenderer(a.renderer);this.resizeMode=a.resizeMode||this.resizeMode;this.displayDivId=a.displayDivId||this.displayDivId;this.stageWidth=a.stageWidth||this.stageWidth;this.stageHeight=a.stageHeight||this.stageHeight;this.screenWidth=a.screenWidth||this.screenWidth;this.screenHeight=a.screenHeight||this.screenHeight;this.stageHAlign="undefined"!==typeof a.stageHAlign?
a.stageHAlign:this.stageHAlign;this.stageVAlign="undefined"!==typeof a.stageHAlign?a.stageVAlign:this.stageVAlign;this.useLargeImage=a.useLargeImage||this.useLargeImage};h.prototype.handleException_=function(a,d){var f=d.pageTransitionMap,g=null;f.hasOwnProperty("error")?g=f.error:0<_.size(f)&&(g=_.find(f,function(){return!0}));f=d.handler;null===f||void 0===f.exception?confirm("LWF exception. \n"+a.stack+"\n reload?")&&location.reload():_.isFunction(f.exception)&&f.exception(a,g);console.error("[LWF] exception: %s",
a.stack)};h.prototype.handleLoadError_=function(a,d){var f=d.pageTransitionMap,g=null;f.hasOwnProperty("error")?0<_.size(f)&&(g=_.find(f,function(){return!0})):g=f.error;f=d.handler;null===f||void 0===f.loadError?confirm("LWF load error. \n reload?")&&location.reload():_.isFunction(f.loadError)&&f.loadError(a,g);console.error("[LWF] load error: %o",a.error);console.error("[LWF] loaded count: %d/%d",a.loadedCount,a.total)};h.prototype.onLoad=function(a){var l=a.privateData,f=l.lwfLoader;f.lwfInstances[f.lwfLoaderUid]=
a;l.loaderUid=f.lwfLoaderUid++;var g=this,b=g.privateData._loaderData,c=b.loader,e=b.stageEventReceiver;g.privateData=null;if(a){if(_.isFunction(b.callback.onLoad))b.callback.onLoad(a);var h,m,u,z,C,n=this.stage,y=0,A=0,w=1,q=0,r=0,G=d.performance.now(),H=0,K=G,I=0;a.rootMovie.moveTo(c.rootOffset.x,c.rootOffset.y);d.lwfs_loader_mode||(a.width=c.stageWidth?c.stageWidth:a.width,a.height=c.stageHeight?c.stageHeight:a.height);d.lwfWidth=a.width;d.lwfHeight=a.height;var D=d.devicePixelRatio;"useWebkitCSSRenderer"===
c.getRenderer()&&(D=1);"useWebGLRenderer"===c.getRenderer()&&/ F-/.test(k)&&(D=2);"useWebkitCSSRenderer"===c.getRenderer()&&/Android 2\.3\.[5-7]/.test(k)&&/SH/.test(k)&&(this.stage.style.opacity=.9999);h=function(){try{if(a){c.gotoRewind&&(c.gotoRewind=!1,a.init());var f=c.stageWidth?c.stageWidth:a.width,v=c.stageHeight?c.stageHeight:a.height,p=c.screenWidth?c.screenWidth:d.innerWidth,l=c.screenHeight?c.screenHeight:d.innerHeight,m=p/l,z=f/v;x&&(d.innerWidth>d.screen.width&&(p=d.screen.width),d.innerHeight>
d.screen.height&&(l=d.screen.height));if(y!==p||A!==l){q=f;r=v;c.fitToScreen?m<z?(q=p,r=p/f*v):(q=l/v*f,r=l):g.fitForWidth?(q=Math.round(p),r=Math.round(p*v/f)):g.fitForHeight&&(q=Math.round(l*f/v),r=Math.round(l));v=f=0;f=-1==c.stageHAlign?0:1==c.stageHAlign?Math.round(p-q):Math.round((p-q)/2);v=-1==c.stageVAlign?0:1==c.stageVAlign?Math.round(l-r):Math.round((l-r)/2);e.style.left=n.style.left=f+"px";e.style.top=n.style.top=v+"px";e.style.width=n.style.width=q+"px";e.style.height=n.style.height=r+
"px";e.width=n.width=Math.floor(q*D);e.height=n.height=Math.floor(r*D);a.property.clear();c.fitToScreen?m<z?(w=q/n.width,a.fitForWidth(n.width,n.height)):(w=r/n.height,a.fitForHeight(n.width,n.height)):g.fitForWidth?(w=q/n.width,a.fitForWidth(n.width,n.height)):(w=r/n.height,a.fitForHeight(n.width,n.height));"useWebkitCSSRenderer"===c.getRenderer()&&a.setTextScale(window.devicePixelRatio);a.property.moveTo(0,0);if(c.displayDivId){var k=document.getElementById(c.displayDivId);c.fitToScreen?(k.style.width=
p+"px",k.style.height=l+"px"):(k.style.width=q+"px",k.style.height=r+"px")}y=p;A=l}var u=d.performance.now(),p=u-G;G=u;c.pausing||(a.exec(p/1E3),a.render());var t=a.privateData;t.lwfLoader.timers[t.lwfLoaderUid]=d.requestAnimationFrame(h);0===H%60&&(I=Math.round(6E4/(u-K)),K=u,H=0);if(c.debug||b.debug)document.getElementById("lwf_info"+b.debugInfoElementId).innerHTML=I+"fps";H++;c.setCurrentFPS(I)}}catch(C){c.handleException_(C,b)}};m=function(d){try{if(c.isPreventDefaultEnabled&&d.preventDefault(),
a){var e,f,g=n.getBoundingClientRect();if(t){var l=d.touches[0];e=l.pageX;f=l.pageY}else e=d.clientX,f=d.clientY;t?(e=e-g.left-window.scrollX,f=f-g.top-window.scrollY):(e-=g.left,f-=g.top);e/=w;f/=w;a.inputPoint(e,f)}}catch(h){c.handleException_(h,b)}};u=function(d){try{if(c.isPreventDefaultEnabled&&d.preventDefault(),a){var e,f,g=n.getBoundingClientRect();if(t){var l=d.touches[0];e=l.pageX;f=l.pageY}else e=d.clientX,f=d.clientY;t?(e=e-g.left-window.scrollX,f=f-g.top-window.scrollY):(e-=g.left,f-=
g.top);e/=w;f/=w;a.inputPoint(e,f);a.inputPress()}}catch(h){c.handleException_(h,b)}};z=function(d){try{c.isPreventDefaultEnabled&&d.preventDefault(),a&&a.inputRelease()}catch(e){c.handleException_(e,b)}};C=function(e){try{a&&d.location.reload(!0)}catch(f){c.handleException_(f,b)}};f.timers[l.lwfLoaderUid]=d.requestAnimationFrame(h);t?(x&&(J||/ SC-0/.test(k))&&document.body.addEventListener("touchstart",function(){}),F&&(c.debug||b.debug)&&e.addEventListener("gestureend",C,!1),e.addEventListener("touchmove",
m,!1),e.addEventListener("touchstart",u,!1),e.addEventListener("touchend",z,!1)):(e.addEventListener("mousemove",m,!1),e.addEventListener("mousedown",u,!1),e.addEventListener("mouseup",z,!1));_.each(b.buttonEventMap,function(b,c){_.isFunction(b)?b={release:b}:_.each(b,function(a,b){if(!_.isFunction(a))throw Error("button event ["+b+"@"+c+"] is not a function!");});a.setButtonEventHandler(c,b)});var B={},E=function(a,b){B.hasOwnProperty(a)||(B[a]=[]);B[a].push(b)};_.isObject(b.fsCommandMap)&&_.each(b.fsCommandMap,
function(a,b){_.isFunction(a)&&E(b,a)});_.isObject(b.pageTransitionMap)&&_.each(b.pageTransitionMap,function(a,b){_.isString(a)?E(b,function(){document.location.href=a}):_.isFunction(a)&&E(b,function(){a(b)})});E=null;_.each(B,function(b,c){a.setEventHandler(c,function(a,c){for(var d=b.length,e=0;e<d;++e)b[e](a,c)})});B=null}else c.handleLoadError_(this,b)};h.prototype.playLWF=function(a,l){var f=a.getAttribute("data-lwf-display_setting");f&&(f=JSON.parse(f),this.setDisplaySetting(f));f=d.LWF;this.getRenderer()||
this.setRenderer(this.autoSelectRenderer_());var g=this.getRenderer();if(g)f[g]();else throw Error("Renderer parameters are not properly set");f=f.ResourceCache.get();this.debug&&(d.LWFLOADER_ENABLE_DEBUG=!0);var b={};b.onload=this.onLoad;null!==this.backgroundColor?b.setBackgroundColor=this.backgroundColor:b.useBackgroundColor=!0;b.fitForHeight=!1;b.fitForWidth=!1;"fitForWidth"===this.resizeMode?b.fitForWidth=!0:"fitForHeight"===this.resizeMode?b.fitForHeight=!0:"fitToScreen"===this.resizeMode&&
(this.fitToScreen=!0);b.fitToScreen=this.fitToScreen;b.worker=y;x&&/ (SC-0|Galaxy Nexus|SH-0|SCL21)/.test(k)&&(b.quirkyClearRect=!0);x&&(b.use3D=!1);b.privateData={};b.pos=null;b.imageMap={};b.soundMap={};b.pageTransitionMap={};b.buttonEventMap={};b.fsCommandMap={};b.handler={};b.callback={};b.lwfMap=null;for(var c=function(a){return a.charAt(1).toUpperCase()},e=0;e<a.attributes.length;e++){var h=a.attributes[e];if(h.name&&0===h.name.indexOf("data-lwf-")){var m=h.name.slice(9),m=m.replace(/_./g,c);
if("displaySetting"!==m){h=h.value;try{"{"===h.charAt(0)&&(h=JSON.parse(h))}catch(u){}b[m]=h}}}2===d.devicePixelRatio&&this.useLargeImage&&(b.imageSuffix="_@2x");b.hasOwnProperty("lwf")||(c=a.getAttribute("data-lwf"),_.isString(c)&&(b.lwf=c));b.hasOwnProperty("name")&&(b.lwf=b.name);_.isObject(l)&&_.extend(b,l);0<this.initializeHooks.length&&_.each(this.initializeHooks,_.bind(function(c){if(_.isFunction(c)){c=c.call(this,a);for(var e in c)c.hasOwnProperty(e)&&_.extend(b[e],c[e])}},this));this.initializeHooks=
