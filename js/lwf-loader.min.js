...
a;l.loaderUid=f.lwfLoaderUid++;var g=this,b=g.privateData._loaderData,c=b.loader,e=b.stageEventReceiver;g.privateData=null;if(a){if(_.isFunction(b.callback.onLoad))b.callback.onLoad(a);var h,n,u,z,C,m=this.stage,y=0,A=0,w=1,q=0,r=0,G=d.performance.now(),H=0,K=G,I=0;a.rootMovie.moveTo(c.rootOffset.x,c.rootOffset.y);d.lwfs_loader_mode||(a.width=c.stageWidth?c.stageWidth:a.width,a.height=c.stageHeight?c.stageHeight:a.height);d.lwfWidth=a.width;d.lwfHeight=a.height;var D=d.devicePixelRatio;"useWebkitCSSRenderer"===
c.getRenderer()&&(D=1);"useWebGLRenderer"===c.getRenderer()&&/ F-/.test(k)&&(D=2);"useWebkitCSSRenderer"===c.getRenderer()&&/Android 2\.3\.[5-7]/.test(k)&&/SH/.test(k)&&(this.stage.style.opacity=.9999);h=function(){try{if(a){c.gotoRewind&&(c.gotoRewind=!1,a.init());var f=c.stageWidth?c.stageWidth:a.width,v=c.stageHeight?c.stageHeight:a.height,p=c.screenWidth?c.screenWidth:d.innerWidth,l=c.screenHeight?c.screenHeight:d.innerHeight,n=p/l,z=f/v;x&&(d.innerWidth>d.screen.width&&(p=d.screen.width),d.innerHeight>
d.screen.height&&(l=d.screen.height));if(y!==p||A!==l){q=f;r=v;g.fitForWidth?(q=Math.round(p),r=Math.round(p*v/f)):g.fitForHeight?(q=Math.round(l*f/v),r=Math.round(l)):b.fitToScreen&&(n>z?(q=l/v*f,r=l):(q=p,r=p/f*v));v=f=0;f=-1==c.stageHAlign?0:1==c.stageHAlign?Math.round(p-q):Math.round((p-q)/2);v=-1==c.stageVAlign?0:1==c.stageVAlign?Math.round(l-r):Math.round((l-r)/2);m.width=c.stageWidth?c.stageWidth:m.width;m.height=c.stageHeight?c.stageHeight:m.height;e.style.left=m.style.left=f+"px";e.style.top=
m.style.top=v+"px";e.style.width=m.style.width=q+"px";e.style.height=m.style.height=r+"px";e.width=m.width=Math.floor(q*D);e.height=m.height=Math.floor(r*D);b.fitToScreen?n<z?(w=q/m.width,a.property.clear(),a.fitForWidth(m.width,m.height)):(w=r/m.height,a.property.clear(),a.fitForHeight(m.width,m.height)):g.fitForWidth?(w=q/m.width,a.property.clear(),a.fitForWidth(m.width,m.height)):(w=r/m.height,a.property.clear(),a.fitForHeight(m.width,m.height));"useWebkitCSSRenderer"===c.getRenderer()&&a.setTextScale(window.devicePixelRatio);
a.property.moveTo(0,0);if(c.displayDivId){var k=document.getElementById(c.displayDivId);b.fitToScreen?(k.style.width=p+"px",k.style.height=l+"px"):(k.style.width=q+"px",k.style.height=r+"px")}y=p;A=l}var u=d.performance.now(),p=u-G;G=u;c.pausing||(a.exec(p/1E3),a.render());var t=a.privateData;t.lwfLoader.timers[t.lwfLoaderUid]=d.requestAnimationFrame(h);0===H%60&&(I=Math.round(6E4/(u-K)),K=u,H=0);if(c.debug||b.debug)document.getElementById("lwf_info"+b.debugInfoElementId).innerHTML=I+"fps";H++;c.setCurrentFPS(I)}}catch(C){c.handleException_(C,
b)}};n=function(d){try{if(c.isPreventDefaultEnabled&&d.preventDefault(),a){var e,f,g=m.getBoundingClientRect();if(t){var l=d.touches[0];e=l.pageX;f=l.pageY}else e=d.clientX,f=d.clientY;t?(e=e-g.left-window.scrollX,f=f-g.top-window.scrollY):(e-=g.left,f-=g.top);e/=w;f/=w;a.inputPoint(e,f)}}catch(h){c.handleException_(h,b)}};u=function(d){try{if(c.isPreventDefaultEnabled&&d.preventDefault(),a){var e,f,g=m.getBoundingClientRect();if(t){var l=d.touches[0];e=l.pageX;f=l.pageY}else e=d.clientX,f=d.clientY;
t?(e=e-g.left-window.scrollX,f=f-g.top-window.scrollY):(e-=g.left,f-=g.top);e/=w;f/=w;a.inputPoint(e,f);a.inputPress()}}catch(h){c.handleException_(h,b)}};z=function(d){try{c.isPreventDefaultEnabled&&d.preventDefault(),a&&a.inputRelease()}catch(e){c.handleException_(e,b)}};C=function(e){try{a&&d.location.reload(!0)}catch(f){c.handleException_(f,b)}};f.timers[l.lwfLoaderUid]=d.requestAnimationFrame(h);t?(x&&(J||/ SC-0/.test(k))&&document.body.addEventListener("touchstart",function(){}),F&&(c.debug||
b.debug)&&e.addEventListener("gestureend",C,!1),e.addEventListener("touchmove",n,!1),e.addEventListener("touchstart",u,!1),e.addEventListener("touchend",z,!1)):(e.addEventListener("mousemove",n,!1),e.addEventListener("mousedown",u,!1),e.addEventListener("mouseup",z,!1));_.each(b.buttonEventMap,function(b,c){_.isFunction(b)?b={release:b}:_.each(b,function(a,b){if(!_.isFunction(a))throw Error("button event ["+b+"@"+c+"] is not a function!");});a.setButtonEventHandler(c,b)});var B={},E=function(a,b){B.hasOwnProperty(a)||
...
this.resizeMode?b.fitForHeight=!0:"fitToScreen"===this.resizeMode&&(this.fitToScreen=!0);b.fitToScreen=this.fitToScreen;b.worker=y;x&&/ (SC-0|Galaxy Nexus|SH-0|SCL21)/.test(k)&&(b.quirkyClearRect=!0);x&&(b.use3D=!1);b.privateData={};b.pos=null;b.imageMap={};b.soundMap={};b.pageTransitionMap={};b.buttonEventMap={};b.fsCommandMap={};b.handler={};b.callback={};b.lwfMap=null;for(var c=function(a){return a.charAt(1).toUpperCase()},e=0;e<a.attributes.length;e++){var h=a.attributes[e];if(h.name&&0===h.name.indexOf("data-lwf-")){var n=
h.name.slice(9),n=n.replace(/_./g,c);if("displaySetting"!==n){h=h.value;try{"{"===h.charAt(0)&&(h=JSON.parse(h))}catch(u){}b[n]=h}}}2===d.devicePixelRatio&&this.useLargeImage&&(b.imageSuffix="_@2x");b.hasOwnProperty("lwf")||(c=a.getAttribute("data-lwf"),_.isString(c)&&(b.lwf=c));b.hasOwnProperty("name")&&(b.lwf=b.name);_.isObject(l)&&_.extend(b,l);0<this.initializeHooks.length&&_.each(this.initializeHooks,_.bind(function(c){if(_.isFunction(c)){c=c.call(this,a);for(var e in c)c.hasOwnProperty(e)&&
